...
<jsp:include page="../../include/header.jsp"></jsp:include>
	...
	<!-- Include our scripts -->
	<script type="text/javascript" src="/backbone/resources/js/leave/leave-search.app.js"></script>
	<script type="text/javascript" src="/backbone/resources/js/leave/leave.rest.js"></script>
	
	<!-- Main content view -->
	<div ng-controller="LeaveSearchCtrl" style="margin-top: 60px; margin-bottom: 60px">
