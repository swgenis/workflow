		...
		<h1>Tasklist</h1>
			...
			<div>
				<form class="form-inline">
					...
					<button type="submit" class="btn btn-default" ng-click="searchLeaveTasks()">Search</button>
				</form>
			</div>
			<div>
				<table class="table table-bordered">
					...
					<tbody>
						<tr ng-repeat="task in tasks">
							...
							<td>{{task.status}}</td>
							<td>
								<button class="btn btn-primary" type="button" ng-click="approveLeave(task)">Approve</button>
								<button class="btn btn-danger" type="button" ng-click="denyLeave(task)">Deny</button>
							</td>
						<tr>
					</tbody>
				</table>
