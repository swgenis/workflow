...
<meta charset="utf-8" />
	...
	<!-- Include our scripts -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nwu-backbone.app.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/nwu-backbone.directives.js"></script>
	...
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		...
		<div class="navbar-collapse collapse no-transition">
			<ul class="nav navbar-nav">
				...
				<li><a href="${pageContext.request.contextPath}/jsp/taskList.jsp"><span class="glyphicon glyphicon-home">&nbsp;</span>Task List</a></li>
			</ul>
		</div>
		<!--/.nav-collapse -->
	</nav>
