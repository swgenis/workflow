...
public class OrganizationServiceDecorator
    ...
    @Override
    public List<String> searchForOrgIds(Criteria criteria, ContextInfo contextInfo) 
	    throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
        return getNextDecorator().searchForOrgIds(criteria, contextInfo);
    }

    @Override
    public List<OrgInfo> searchForOrgs(Criteria criteria, ContextInfo contextInfo) 
	    throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
    ...
    @Override
    public List<String> searchForOrgOrgRelationIds(Criteria criteria, ContextInfo contextInfo) 
	    throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
        return getNextDecorator().searchForOrgOrgRelationIds(criteria, contextInfo);
    }

    @Override
    public List<OrgOrgRelationInfo> searchForOrgOrgRelations(Criteria criteria, ContextInfo contextInfo) 
	    throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
    ...
    @Override
    public List<String> searchForOrgPersonRelationIds(Criteria criteria, ContextInfo contextInfo) 
	    throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
        return getNextDecorator().searchForOrgPersonRelationIds(criteria, contextInfo);
    }

    @Override
    public List<OrgPersonRelationInfo> searchForOrgPersonRelations(Criteria criteria, ContextInfo contextInfo) 
	    throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
    ...
    @Override
    public List<String> searchForOrgPositionRestrictionIds(Criteria criteria, ContextInfo contextInfo) 
	    throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
        return getNextDecorator().searchForOrgPositionRestrictionIds(criteria, contextInfo);
    }

    @Override
    public List<OrgPositionRestrictionInfo> searchForOrgPositionRestrictions(Criteria criteria, ContextInfo contextInfo) 
	    throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
    ...
    @Override
    public List<String> searchForOrgHierarchyIds(Criteria criteria, ContextInfo contextInfo) 
	    throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
        return getNextDecorator().searchForOrgHierarchyIds(criteria, contextInfo);
    }

    @Override
    public List<OrgHierarchyInfo> searchForOrgHierarchies(Criteria criteria, ContextInfo contextInfo) 
	    throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException {
