...
public interface PersonService {
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<String> searchForPersonIds(@WebParam(name = "criteria") Criteria criteria,
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<PersonInfo> searchForPersons(@WebParam(name = "criteria") Criteria criteria,
                                             @WebParam(name = "contextInfo") ContextInfo contextInfo) throws DoesNotExistException,
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<String> searchForPersonNameIds(@WebParam(name = "criteria") Criteria criteria,
                                               @WebParam(name = "contextInfo") ContextInfo contextInfo) throws
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<PersonNameInfo> searchForPersonNames(@WebParam(name = "criteria") Criteria criteria,
                                                     @WebParam(name = "contextInfo") ContextInfo contextInfo) throws
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<String> searchForPersonIdentifierIds(@WebParam(name = "criteria") Criteria criteria,
                                                     @WebParam(name = "contextInfo") ContextInfo contextInfo) throws
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<PersonIdentifierInfo> searchForPersonIdentifiers(@WebParam(name = "criteria") Criteria criteria,
                                                                 @WebParam(name = "contextInfo") ContextInfo contextInfo) throws
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<String> searchForPersonBioDemographicsIds(@WebParam(name = "criteria") Criteria criteria,
                                                          @WebParam(name = "contextInfo") ContextInfo contextInfo) throws
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<PersonBioDemographicsInfo> searchForPersonBioDemographics(@WebParam(name = "criteria") Criteria criteria,
                                                                          @WebParam(name = "contextInfo") ContextInfo contextInfo) throws
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<String> searchForPersonAffiliationIds(@WebParam(name = "criteria") Criteria criteria,
                                                      @WebParam(name = "contextInfo") ContextInfo contextInfo) throws
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<PersonAffiliationInfo> searchForPersonAffiliations(@WebParam(name = "criteria") Criteria criteria,
                                                                   @WebParam(name = "contextInfo") ContextInfo contextInfo) throws
            InvalidParameterException,
            MissingParameterException,
            OperationFailedException,
