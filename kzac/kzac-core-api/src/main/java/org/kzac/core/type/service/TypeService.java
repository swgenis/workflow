...
package org.kzac.core.type.service;
...
import org.kzac.core.constants.TypeServiceConstants;
import org.kzac.core.type.dto.TypeInfo;
import org.kzac.core.type.dto.TypeTypeRelationInfo;
import org.kzac.exceptions.AlreadyExistsException;
...
public interface TypeService {
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<String> searchForTypeKeys(@WebParam(name = "criteria") CriteriaQuery<TypeInfo> criteria, @WebParam(name = "contextInfo") ContextInfo contextInfo) throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException;
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<TypeInfo> searchForTypes(@WebParam(name = "criteria") CriteriaQuery<TypeInfo> criteria, @WebParam(name = "contextInfo") ContextInfo contextInfo) throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException;
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<String> searchForTypeTypeRelationIds (@WebParam(name = "criteria") CriteriaQuery<TypeInfo> criteria, @WebParam(name = "contextInfo") ContextInfo contextInfo) throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException;
     ...
     * @throws PermissionDeniedException an authorization failure occurred
     */
    public List<TypeTypeRelationInfo> searchForTypeTypeRelations(@WebParam(name = "criteria") CriteriaQuery<TypeInfo> criteria, @WebParam(name = "contextInfo") ContextInfo contextInfo) throws InvalidParameterException, MissingParameterException, OperationFailedException, PermissionDeniedException;
