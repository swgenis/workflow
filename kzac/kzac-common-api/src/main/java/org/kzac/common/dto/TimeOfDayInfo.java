...
import org.kzac.common.infc.TimeOfDay;
...
public class TimeOfDayInfo implements TimeOfDay, Comparable<TimeOfDay>, Serializable {
     ...
     * 
     * @param hour
     *            of the day in military time (14 is 2pm)
     */
	...
	LocalDateTime result = new LocalDateTime(time.getYear(), time.getMonthOfYear(), time.getDayOfMonth(),
		timeOfDay.getHour() == null ? 0 : timeOfDay.getHour(), timeOfDay.getMinute() == null ? 0
			: timeOfDay.getMinute(), timeOfDay.getSecond() == null ? 0 : timeOfDay.getSecond(), 0);
	return result.toDateTime().toDate();
    }

    /**
     * Tests if this TimeOfDay is after the specified TimeOfDay. The assumption
     * is that timeOfDay.hour is military time (14 is 2pm)
     * 
     * @param other
     *            the specified TimeOfDay
     * @return true if this TimeOfDay is after the specified TimeOfDay, false
     *         otherwise.
     */
    @Override
    ...
    /**
     * Tests if this TimeOfDay is before the specified TimeOfDay. The assumption
     * is that timeOfDay.hour is military time (14 is 2pm)
     * 
     * @param other
     *            the specified TimeOfDay
     * @return true if this TimeOfDay is before the specified TimeOfDay, false
     *         otherwise.
     */
    @Override
    ...
    /**
     * Compares two TimeOfDays for equality. The result is true if and only if
     * the argument is not null and is a TimeOfDay object that represents the
     * same time of day as this object.
     * 
     * @param obj
	...
	return "TimeOfDayInfo{" + getHour() + ":" + (getMinute() != 0 ? getMinute() : "00") + ":"
     ...
     * 
     * @param other
     *            a TimeOfDay to check against
     * @return negative if this is less, zero if equal, positive if greater
     * @throws NullPointerException
     *             if the TimeOfDay is null
     */
